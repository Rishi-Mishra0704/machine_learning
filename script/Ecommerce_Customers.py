...
csv_path = os.path.join(working_dir, "..", 'data', 'Ecommerce_Customers.csv')
...
print("R-Squared: ",metrics.explained_variance_score(y_test,preds))
...
# *Answer here*<br />
# Length of Membership is the most important feature. The company should focus on the mobile app as it has a higher coefficient than the website.
